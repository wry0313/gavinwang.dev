                ...
                <div className="flex flex-col item-center">
                    <div className="mx-auto">
                        ...
                        <div className="flex flex-col md:flex-row items-center bg-[#F5F7F7] shadow rounded-lg px-3 py-2">
                            <input className="hover:scale-105  duration-300 w-[250px] md:w-[70%] mb-[0.3rem] md:mb-0 text-sm md:text-base flex-1 md:mr-[0.8rem] h-12 hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-200 rounded shadow" type="file" id="fileInput" onChange={handleFileInputChange} />
                    ...
                    <div className="no-scrollbar flex mt-[2rem] overflow-x-scroll bg-[#F5F7F7] shadow rounded-lg py-2">
                        ...
                        <Image className="flex-none mx-1 rounded-lg hover:scale-110 duration-300" onClick={() => handleImageClick('/project/cat.jpeg')} src="/project/cat.jpeg" height={100} width={(225 / 225) * 100} alt="Cat 1" />
                        <Image className="flex-none mx-1 rounded-lg hover:scale-110 duration-300" onClick={() => handleImageClick('/project/funny.jpeg')} src="/project/funny.jpeg" height={100} width={(310 / 163) * 100} alt="Cat or Dog? 1" />
                        <Image className="flex-none mx-1 rounded-lg hover:scale-110 duration-300" onClick={() => handleImageClick('/project/funny1.jpeg')} src="/project/funny1.jpeg" height={100} width={(1200 / 1200) * 100} alt="Cat or Dog 2" />
                        <Image className="flex-none mx-1 rounded-lg hover:scale-110 duration-300" onClick={() => handleImageClick('/project/funny3.jpg')} src="/project/funny3.jpg" height={100} width={(390 / 291) * 100} alt="Cat or Dog 3" />
                        <Image className="flex-none mr-2 ml-1 rounded-lg hover:scale-110 duration-300" onClick={() => handleImageClick('/project/fox.jpeg')} src="/project/fox.jpeg" height={100} width={(1200 / 862) * 100} alt="Fox" />
                    </div>
                </div>
            </div>
